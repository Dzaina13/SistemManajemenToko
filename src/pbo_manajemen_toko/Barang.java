...
public class Barang extends javax.swing.JFrame {
    ...
    public Barang() {
        ...
        //auto fullscreen
        setExtendedState(Barang.MAXIMIZED_BOTH);
        //bg warna putih
    ...
    private void initComponents() {
        ...
        barangBtn.setFont(new java.awt.Font("Poppins Medium", 1, 14)); // NOI18N
        barangBtn.setForeground(new java.awt.Color(50, 142, 110));
        barangBtn.setText("Barang");
        barangBtn.setToolTipText("");
        barangBtn.setVerticalAlignment(javax.swing.SwingConstants.BOTTOM);

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resource/icons/box.png"))); // NOI18N
        ...
        role.setFont(new java.awt.Font("Poppins Medium", 0, 14)); // NOI18N
        role.setForeground(new java.awt.Color(123, 122, 120));
        role.setText("Super-admin");
        role.setToolTipText("");
        role.setVerticalAlignment(javax.swing.SwingConstants.BOTTOM);
        ...
        tittle.setText("Manajemen Barang");
        ...
        tabel_barang.setFont(new java.awt.Font("Poppins", 0, 12)); // NOI18N
    ...
    private void addBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addBtnActionPerformed
        // TODO add your handling code here:
        TambahBarang tambahBarang = new TambahBarang(this);
    ...
    private void editBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editBtnActionPerformed
        ...
        String nama = tabel_barang.getValueAt(selectedRow, 1).toString();
        String stok = tabel_barang.getValueAt(selectedRow, 2).toString();
        String harga = tabel_barang.getValueAt(selectedRow, 3).toString();

        // Kirim ke frame EditBarang
        EditBarang editFrame = new EditBarang(this, id, nama, stok, harga);
    ...
    private void deleteBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteBtnActionPerformed
        ...
        if (konfirmasi == JOptionPane.YES_OPTION) {
            try {
                ...
                //tambah ke histori
                String aktivitas = "menghapus data barang:"+nama_barang;
    ...
    public void cariData(String keyword) {
        ...
        try {
            String query = "SELECT * FROM items WHERE nama_item LIKE ? ";
            java.sql.Connection Vconn = (Connection)Koneksi.konfigDB();
            java.sql.PreparedStatement s = Vconn.prepareStatement(query);
